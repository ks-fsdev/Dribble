  ...
  return (
    <>
      <div
        className={
          isFocused
            ? "w-full flex bg-white rounded-full py-1 pl-6 pr-1  justify-between ring-3 ring-[#EA4C89]/20"
            : "w-full flex bg-neutral-100 rounded-full py-1 pl-6 pr-1  justify-between"
        }>
        <input
          type="text"
          placeholder={search}
          className="outline-0 w-[90%] xl:w-[80%] cursor-auto"
