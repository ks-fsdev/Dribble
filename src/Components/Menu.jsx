...
function Menu(menuStatus) {
  let [exploreOpen, setExplore] = useState(false);
  const exploreHandler = () => {
    setExplore((prev) => !prev);
  };

  let [talentOpen, setTalent] = useState(false);
  const talentHandler = () => {
    setTalent((prev) => !prev);
  };

  let [hireOpen, setHire] = useState(false);
  const hireHandler = () => {
    setHire((prev) => !prev);
  };
  ...
  return (
    <>
      <div className="block xl:hidden w-screen absolute top-16 lg:top-21.5 -z-40 bg-white left-0 p-4 lg:px-10">
        <div className="custom-font-family">
          <p
            className="font-bold text-[18px] flex items-center gap-4 cursor-pointer"
          ...
          <div>
            <div className="py-3">
              <p className="py-2.5 cursor-pointer hover:text-black/60 rounded-lg flex gap-3 font-semibold">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <p className="py-2.5  cursor-pointer hover:text-black/60 rounded-lg flex items-center gap-3 font-semibold">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className="py-3">
              <p className="custom-font py-3 cursor-pointer hover:text-black/60 rounded-lg">
                Web Design
              </p>
              <p className="custom-font py-3 cursor-pointer hover:text-black/60 rounded-lg">
                Animation
        ...
        <div className="custom-font-family py-3">
          <p
            className="font-bold text-[18px] flex items-center gap-4"
          ...
          <div className="py-3">
            <p className="p-2.5 cursor-pointer hover:text-black/60 rounded-lg flex gap-3 font-semibold">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        <div className="custom-font-family py-3">
          <p className="font-bold text-[18px] ">Blog</p>
        </div>
      </div>

      <div
        className={
          "absolute w-screen h-screen bg-stone-500 top-16 lg:top-21.5 left-0 transition-all duration-300 -z-30" +
          (menuStatus
